...
class BattleTest {
    ...
    static List<Arguments> parameterizedTest() {
        return List.of(
                ...
                arguments(new Army().addUnits(Warrior::new, 2), new Army().addUnits(Lancer::new, 1).addUnits(Warrior::new,1), false),
                arguments(new Army().addUnits(Lancer::new, 1), new Army().addUnits(Lancer::new, 1), true),


                //HEALER TESTS
                arguments(new Army().addUnits(Lancer::new, 7).addUnits(Vampire::new, 3).addUnits(Warrior::new, 4).addUnits(Healer::new, 1).addUnits(Defender::new,2),
                        new Army().addUnits(Warrior::new, 4).addUnits(Defender::new, 4).addUnits(Healer::new, 1).addUnits(Vampire::new, 6).addUnits(Lancer::new,4), true),
                arguments(new Army().addUnits(Lancer::new, 1).addUnits(Warrior::new, 3).addUnits(Healer::new, 1)
